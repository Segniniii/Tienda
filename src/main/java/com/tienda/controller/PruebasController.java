...
public class PruebasController {
    ...
    @PostMapping("/query4")
    public String consultaQueryExistencias(@RequestParam(value = "existenciasInf") int existenciasInf,
    ...
    // Nuevo método para filtrar productos por estado (activo/inactivo)
    @PostMapping("/query5")
    public String consultaQueryEstado(@RequestParam(value = "activo") boolean activo, Model model) {
